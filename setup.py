...
setuptools.setup(
    name="fineserve",
    version=find_version(get_path("fineserve", "__init__.py")),
    author="FineServe Devs",
    license="Apache 2.0",
    description=("FineServe: A Serving System for Quantized-LLM with Fine-Grained GPU Scheduling"),
